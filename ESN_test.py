...
#open test data
with open(f'../trajectory/test_trace_LV.pkl', 'rb') as file:
...
class ESN:
    ...
    def training(self, data):
        ...
        states[0] = np.tanh(test_data[0] @ self.Win)
        for i in range(1,train_size):
            states[i] = np.tanh(states[i-1] @ self.A + test_data[i] @ self.Win)
...
#Uploading trained weights to the model
